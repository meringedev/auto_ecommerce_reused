(() => {
  ...
  var require_shared_gen_func = __commonJS({
    "js/shared/shared_gen_func.js"(exports, module) {
      ...
      function url_check2(url_substring) {
        let is_full2 = false;
      ...
      module.export = { get_prop_by_string, return_page, return_auth_page, url_id_check, url_check: url_check2 };
    }
  });
  ...
  var { url_check } = require_shared_gen_func();
  var { check_user: check_user2 } = (init_sens(), __toCommonJS(sens_exports));
  var is_full = url_check("shopping-cart");
  ...
  function mini_html_items(data) {
    ...
    let html = `<div class="row shopping_cart_product_cont_mini" data-shopping-cart-item-id="${data.shopping_cart_item_id}">
  ...
  function main_html_items(data) {
    let img_location = `/public/${data.product_img_thumb}`;
    let html = `<div class="container shopping_cart_product_cont" data-shopping-cart-item-id="${data.shopping_cart_item_id}">
  ...
  function load_mini_checkout(shopping_cart2, shopping_cart_items) {
    mini_html(shopping_cart2);
    $("#shopping_cart_product_cont_all").empty();
    let shopping_cart_item_array = [];
    for (let item of shopping_cart_items) {
      let main_html2 = mini_html_items(item);
      shopping_cart_item_array.push(main_html2);
    }
    $(".shop_options_cart_products").append(shopping_cart_item_array);
    $("hr").last().remove();
  }
  function load_full_checkout(shopping_cart2, shopping_cart_items) {
    $("#shopping_cart_product_cont_all").empty();
    let shopping_cart_item_array = [];
    for (let item of shopping_cart_items) {
      let main_html2 = main_html_items(item);
      shopping_cart_item_array.push(main_html2);
    }
    $("#shopping_cart_product_cont_all").append(shopping_cart_item_array);
    $("hr").last().remove();
    main_html(shopping_cart2);
  }
})();
