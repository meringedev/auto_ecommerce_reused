(() => {
  ...
  var require_axios = __commonJS({
    "node_modules/axios/dist/browser/axios.cjs"(exports, module) {
      ...
      var axios6 = createInstance2(defaults$1);
      axios6.Axios = Axios$1;
      axios6.CanceledError = CanceledError3;
      axios6.CancelToken = CancelToken$1;
      axios6.isCancel = isCancel3;
      axios6.VERSION = VERSION3;
      axios6.toFormData = toFormData3;
      axios6.AxiosError = AxiosError3;
      axios6.Cancel = axios6.CanceledError;
      axios6.all = function all3(promises) {
        return Promise.all(promises);
      };
      axios6.spread = spread3;
      axios6.isAxiosError = isAxiosError3;
      axios6.mergeConfig = mergeConfig3;
      axios6.AxiosHeaders = AxiosHeaders$1;
      axios6.formToJSON = (thing) => formDataToJSON2(utils$1.isHTMLForm(thing) ? new FormData(thing) : thing);
      axios6.getAdapter = adapters.getAdapter;
      axios6.HttpStatusCode = HttpStatusCode$1;
  ...
  function html_items_global(data, cont_prefix2, $object2) {
    $object2.find(`${cont_prefix2}_product_global`).each(() => {
      ...
      if (field_value === "quantity" && $2(this).data("is-selection")) {
        ...
        $2(this).find(`option[value='${data.quantity}']`).prop("selected", true);
      } else {
        let value2 = gen_func.get_prop(data, field_value);
        $2(this).text(value2);
      }
    });
  }
...
<hr />`;
  ...
  function mini_html(data) {
    $2(".shop_options_cart_total").text(`TOTAL: ${data.total}`);
  }
  function main_html(data) {
    ...
    $2("#shopping_cart_summary_subtotal").text(`R${data.subtotal}`);
    $2("#shopping_cart_summary_vat").text(`R${data.vat}`);
    $2("#shopping_cart_summary_total").text(`R${data.total}`);
  }
  function html_loader(main_funct, data, opts = null, data_items = null) {
    let empty = false;
  ...
  function is_full_html_load(data, data_items = null, opts = null) {
    let main_funct;
    if (typeof is_full === "undefined") {
      const is_full2 = gen_func.url_check("shopping-cart");
    }
    ...
    html_loader(main_funct, opts, data, data_items);
  }
  function add_cart_item(data) {
    axios3.post(`${global3.ngrok_api_url}/cart/`, data, global3.options).then((res) => {
      const data2 = res.data;
      const flag = data2.flag;
      if (typeof flag !== "undefined" && flag === "updated") {
        inner_update_item(data2);
      } else {
        is_full_html_load(data2.shopping_cart, data2.shopping_cart_items);
      }
    }).catch((err) => {
      console.log(err);
    });
  ...
  function inner_update_item(data) {
    ...
    html_items_global(data.shopping_cart_items, cont_prefix2, $object);
  }
...
`);
 ...
 <div>
  ...
  var { product_func: product_func2 } = (init_products(), __toCommonJS(products_exports));
  var { global: global5 } = require_config();
