(() => {
  ...
  // js/standard/verify.js
  var require_verify = __commonJS({
    "js/standard/verify.js"(exports) {
      var $ = require_jquery();
        ...
        axios.post("http://host.docker.internal:8000/verify_account/", {
          ...
          if ($(e.target).hasClass("signup_verify_resend_code")) {
            ...
            if (message === "OTP has been sent!") {
              $("#signup_verif_select_cont").delay(1e3).slideUp().$("#signup_verif_code_cont").slideDown();
            }
          }
        }).catch((error) => {
          console.log(error);
      ...
      $("#signup_details_submit").on("click", () => {
        ...
        $(`input[name='signup_details']`).each(() => {
          let val = $(exports).val();
          if (val !== void 0 || null) {
            let field = $(exports).data("field-name");
