(() => {
  ...
  // js/standard/logout.js
  var logout_exports = {};
  __export(logout_exports, {
    logout: () => logout
  });
  function logout(withCredentials) {
    axios.post("http://host.docker.internal:3000/logout", { withCredentials }).then(() => {
