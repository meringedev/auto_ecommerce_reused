(() => {
  ...
  // js/sens.js
  var require_sens = __commonJS({
    "js/sens.js"(exports) {
      var token_val = JSON.parse(localStorage.getItem("Token"));
      function return_token(token3) {
        if (token3 === null || token3 === void 0 || token3 === 0) {
          return false;
        } else {
          const token4 = `Token ${token_val}`;
      ...
      var token2 = return_token(token_val);
