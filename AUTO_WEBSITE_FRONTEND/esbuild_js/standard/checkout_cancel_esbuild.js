(() => {
  ...
  var require_shared_gen_func = __commonJS({
    "js/shared/shared_gen_func.js"(exports, module) {
      ...
      module.export = { get_prop_by_string, return_page, return_auth_page, url_id_check: url_id_check2, url_check };
    }
  });
  ...
  // js/standard/checkout_cancel.js
  var axios = require_axios();
  var $ = require_jquery();
  var { url_id_check } = require_shared_gen_func();
  ...
  $(() => {
    ...
    if (is_logged_in) {
      ...
      if (is_id) {
        ...
        axios.get(axios_url, { withCredentials }).then(() => {
          console.log("success!");
        }).catch((err) => {
          console.log(err);
        });
